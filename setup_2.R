...
to.remove <- c("IncomeErr", "IncomePerCap", "IncomePerCapErr", "Poverty", "ChildPoverty", "Native", "Office", "Carpool", "PublicWork")
`%ni%` <- Negate(`%in%`)
...
to.remove <- c("IncomeErr", "Income", "IncomePerCapErr", "Poverty", "ChildPoverty", "Native", "Office", "Carpool", "PublicWork")
`%ni%` <- Negate(`%in%`)
